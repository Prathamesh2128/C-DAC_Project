...
public class JwtUtils {
	...
	public String generateJwtToken(Authentication authentication) {
		...
		// JWT : userName,issued at ,exp date,digital signature(does not contain
		// password n authorities)
		return Jwts.builder() // JWTs : a Factory class , used to create JWT tokens
				...
				.setIssuedAt(new Date()) // Sets the JWT Claims at (issued at) value of current date
